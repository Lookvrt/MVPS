...
public class GuanteTraductorView extends BorderPane {
    ...
    private void initializeUI() {
        ...
        connectionStatus.setStyle("-fx-font-size: 14px; -fx-text-fill: gray;");
        ...
        optionsPane.getChildren().addAll(opcionesTitle);
    ...
    public void setConectarBtnText(String text) {
        conectarBtn.setText(text);
    }
